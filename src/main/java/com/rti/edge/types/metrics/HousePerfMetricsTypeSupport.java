...
public class HousePerfMetricsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "HousePerfMetrics";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final HousePerfMetricsTypeSupport _singleton
    = new HousePerfMetricsTypeSupport();
    ...
    */
    public static HousePerfMetricsTypeSupport get_instance() {
        return _singleton;
    }

    public static HousePerfMetricsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return HousePerfMetricsTypeCode.VALUE;
    }

    public Object create_data() {
        return HousePerfMetrics.create();
    }
    ...
    * <code>this</code> is not a <code>HousePerfMetrics</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        HousePerfMetrics typedDst = (HousePerfMetrics) destination;
        HousePerfMetrics typedSrc = (HousePerfMetrics) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        HousePerfMetrics typedSrc = (HousePerfMetrics) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.ts);

            dst.writeFloat(typedSrc.throughput_per_sec);

            dst.writeFloat(typedSrc.avg_latency_mili);

            dst.writeFloat(typedSrc.min_latency_mili);

            dst.writeFloat(typedSrc.max_latency_mili);

            dst.writeInt(typedSrc.house_id);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            HousePerfMetrics typedDst = (HousePerfMetrics) dst;
            typedDst.clear();      
            try{
                typedDst.ts = src.readInt();
                typedDst.throughput_per_sec = src.readFloat();
                typedDst.avg_latency_mili = src.readFloat();
                typedDst.min_latency_mili = src.readFloat();
                typedDst.max_latency_mili = src.readFloat();
                typedDst.house_id = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            HousePerfMetrics typedDst = (HousePerfMetrics) sample;
    ...
    int mask) {
        return new HousePerfMetricsDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new HousePerfMetricsDataReader(native_reader, listener, mask, this);   
    ...
    protected HousePerfMetricsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,HousePerfMetricsTypeCode.VALUE,HousePerfMetrics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected HousePerfMetricsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,HousePerfMetricsTypeCode.VALUE,HousePerfMetrics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
