...
/**
* A sequence of HousePerfMetrics instances.
*/
public final class HousePerfMetricsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public HousePerfMetricsSeq() {
        super(HousePerfMetrics.class);
    }

    public HousePerfMetricsSeq (int initialMaximum) {
        super(HousePerfMetrics.class, initialMaximum);
    }

    public HousePerfMetricsSeq (Collection elements) {
        super(HousePerfMetrics.class, elements);
    }
