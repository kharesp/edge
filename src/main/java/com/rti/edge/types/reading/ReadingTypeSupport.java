...
public class ReadingTypeSupport extends TypeSupportImpl {
    ...
    */
    ...
    int mask) {
        return new ReadingDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ReadingDataReader(native_reader, listener, mask, this);   
