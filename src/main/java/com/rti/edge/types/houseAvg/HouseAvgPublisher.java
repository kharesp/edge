...
java -Djava.ext.dirs=$NDDSHOME/lib/java HouseAvgPublisher <domain_id>

java -Djava.ext.dirs=$NDDSHOME/lib/java HouseAvgSubscriber <domain_id>        
*/
...
public class HouseAvgPublisher {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        Topic topic = null;
        HouseAvgDataWriter writer = null;
        ...
        try {
            ...
            HouseAvg instance = new HouseAvg();
            ...
            ++count) {
                System.out.println("Writing HouseAvg, count " + count);
