...
public class HouseAvgTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "HouseAvg";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final HouseAvgTypeSupport _singleton
    = new HouseAvgTypeSupport();
    ...
    */
    public static HouseAvgTypeSupport get_instance() {
        return _singleton;
    }

    public static HouseAvgTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return HouseAvgTypeCode.VALUE;
    }

    public Object create_data() {
        return HouseAvg.create();
    }
    ...
    * <code>this</code> is not a <code>HouseAvg</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        HouseAvg typedDst = (HouseAvg) destination;
        HouseAvg typedSrc = (HouseAvg) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        HouseAvg typedSrc = (HouseAvg) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            HouseAvg typedDst = (HouseAvg) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            HouseAvg typedDst = (HouseAvg) sample;
    ...
    int mask) {
        return new HouseAvgDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new HouseAvgDataReader(native_reader, listener, mask, this);   
    ...
    protected HouseAvgTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,HouseAvgTypeCode.VALUE,HouseAvg.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected HouseAvgTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,HouseAvgTypeCode.VALUE,HouseAvg.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
