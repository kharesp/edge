...
public class HouseholdAvgTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "HouseholdAvg";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final HouseholdAvgTypeSupport _singleton
    = new HouseholdAvgTypeSupport();
    ...
    */
    public static HouseholdAvgTypeSupport get_instance() {
        return _singleton;
    }

    public static HouseholdAvgTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return HouseholdAvgTypeCode.VALUE;
    }

    public Object create_data() {
        return HouseholdAvg.create();
    }
    ...
    * <code>this</code> is not a <code>HouseholdAvg</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        HouseholdAvg typedDst = (HouseholdAvg) destination;
        HouseholdAvg typedSrc = (HouseholdAvg) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        HouseholdAvg typedSrc = (HouseholdAvg) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.average);

            dst.writeBoolean(typedSrc.property);

            dst.writeInt(typedSrc.window_size);

            dst.writeInt(typedSrc.household_id);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            HouseholdAvg typedDst = (HouseholdAvg) dst;
            typedDst.clear();      
            try{
                typedDst.ts = src.readInt();
                typedDst.average = src.readFloat();
                typedDst.property = src.readBoolean();
                typedDst.window_size = src.readInt();
                typedDst.household_id = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            HouseholdAvg typedDst = (HouseholdAvg) sample;
    ...
    int mask) {
        return new HouseholdAvgDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new HouseholdAvgDataReader(native_reader, listener, mask, this);   
    ...
    protected HouseholdAvgTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,HouseholdAvgTypeCode.VALUE,HouseholdAvg.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected HouseholdAvgTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,HouseholdAvgTypeCode.VALUE,HouseholdAvg.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
