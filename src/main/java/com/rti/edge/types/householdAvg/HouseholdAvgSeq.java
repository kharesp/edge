...
/**
* A sequence of HouseholdAvg instances.
*/
public final class HouseholdAvgSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public HouseholdAvgSeq() {
        super(HouseholdAvg.class);
    }

    public HouseholdAvgSeq (int initialMaximum) {
        super(HouseholdAvg.class, initialMaximum);
    }

    public HouseholdAvgSeq (Collection elements) {
        super(HouseholdAvg.class, elements);
    }
